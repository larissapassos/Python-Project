...
the paddle scale with each passing level. Our choice of level representation and scaling allows any user to easily create new levels for the game.
...
The images are loaded by pygame's functions while the levels are loaded by python's file I/O functions.
...
In-depth documentation of the aforementioned modules is included in html files generated by pydoc as well as comments on the code.
